...
abstract class Animal extends Object{
	...
	{
		System.out.println("Animal::nonAbstractMethod()");
		// ...
	}
}
...
public class AbstractClassEx01{
	...
	public static void main(String args[]){
		...
		Animal h2 = new Human(); // Animal reference and Animal object
		// Here h2 is a Human object that references to a Animal type

		Bird b1 = new Bird(); // Birds reference and Birds object
		// Here b1 is a Bird object that references to a Birds type

		Animal b2 = new Bird(); // Animals reference and Birds object
		// Here h2 is a Bird object that is a reference to a Animal type
